        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body pl-sm-5">
                    <form method="post" action="{{ url('divisions/save') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12 col-sm-8 col-lg-6">
                                <input type="text" name="name" required="" placeholder="Division Name" class="form-control">
                            </div>
                        </div>
                        <div class="form-group row">
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        lobibox('success','Added','Division added successfully!');
        @endif
