                        ...
                        <form method="post" action="{{ url('divisions/update') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-12 col-sm-8 col-lg-6">
                                    <input type="text" name="code" value="{{ $data->code }}" required="" placeholder="Section Code" class="form-control">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-12 col-sm-3 col-form-label text-sm-right">Name</label>
                                <div class="col-12 col-sm-8 col-lg-6">
                                    <input type="text" name="name" value="{{ $data->name }}" required="" placeholder="Division Name" class="form-control">
                                </div>
                            </div>
                            <div class="form-group row">
                ...
                <div class="modal-body">
                    <div class="text-center">
                        ...
                        <div class="mt-2">
                            ...
                            <a href="{{ url('divisions/delete/'.$data->id) }}" class="btn btn-sm btn-space btn-primary">&nbsp;&nbsp;&nbsp;Yes&nbsp;&nbsp;&nbsp;</a>
                        </div>
                    </div>
                </div>
            </div>
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        lobibox('success','Updated','Division updated successfully!');
        @endif

        @if(session('status')=='denied')
        lobibox('error','Deletion Denied','Please remove all personnel under this division first!');
        @endif
